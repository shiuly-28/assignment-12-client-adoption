...
const DonationDetails = () => {
    ...
    return (
        <div className="container mx-auto py-8">
            <h2 className="text-3xl font-bold mb-4 text-center">{campaign.petName} Donation Campaign</h2>

            <div className="grid md:grid-cols-2 gap-8">
                <img src={campaign.petImage} alt={campaign.petName} className="w-full h-64 object-cover rounded" />
                <div>
